...
func TestUpdateMulticastFlowsAddOne(t *testing.T) {
	fexec := normalSetup()
	addTestResult(t, fexec, "ovs-ofctl -O OpenFlow13 add-flow br0 table=120, reg0=5, actions=output:2", "", nil)
...
func TestUpdateMulticastFlowsAddMany(t *testing.T) {
	fexec := normalSetup()
	addTestResult(t, fexec, "ovs-ofctl -O OpenFlow13 add-flow br0 table=120, reg0=5, actions=output:2,output:7,output:8", "", nil)
...
func TestUpdateMulticastFlowsUpdateOne(t *testing.T) {
	fexec := normalSetup()
	addTestResult(t, fexec, "ovs-ofctl -O OpenFlow13 add-flow br0 table=120, reg0=6, actions=output:2", "", nil)
...
func TestUpdateMulticastFlowsUpdateMany(t *testing.T) {
	fexec := normalSetup()
	addTestResult(t, fexec, "ovs-ofctl -O OpenFlow13 add-flow br0 table=120, reg0=6, actions=output:3,output:7,output:9", "", nil)
	addTestResult(t, fexec, "ovs-ofctl -O OpenFlow13 add-flow br0 table=120, reg0=5, actions=output:2,output:8", "", nil)
